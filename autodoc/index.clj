{:namespaces
 ...
 ({:arglists ([params]),
  ...
  {:arglists ([page above-path]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/caribou.page-api.html#caribou.page/match-action-to-template",
   :doc
  ...
  {:arglists ([env]),
   ...
   :source-url nil,
   :raw-source-url nil,
   :wiki-url "/caribou.app-api.html#caribou.app.config/init",
   :doc
  ...
  {:arglists ([filename env]),
   ...
   :source-url nil,
   :raw-source-url nil,
   :wiki-url "/caribou.app-api.html#caribou.app.config/load-db-config",
   :doc
  ...
  {:arglists ([path]),
   :name "load-templates",
   :namespace "caribou.app.template",
   :source-url nil,
   :raw-source-url nil,
   :wiki-url
   "/caribou.app-api.html#caribou.app.template/load-templates",
   :doc
   "recurse through the view directory and add all the templates that can be found",
   :var-type "function",
   :line 8,
   :file "src/caribou/app/template.clj"}
  {:arglists ([template-name]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/caribou.app-api.html#caribou.app.template.freemarker/get-template",
  ...
  {:arglists ([template-path]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/caribou.app-api.html#caribou.app.template.freemarker/init",
  ...
  {:arglists ([template root template-length] [template root]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/caribou.app-api.html#caribou.app.template.freemarker/render",
  ...
  {:arglists ([template-name]),
   ...
   :raw-source-url nil,
   :wiki-url
   "/caribou.app-api.html#caribou.app.template.freemarker/render-wrapper",
